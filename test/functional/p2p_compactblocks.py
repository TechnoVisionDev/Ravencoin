...
# TestNode: A peer we use to send messages to gemmad, and store responses.
...
class CompactBlocksTest(GemmaTestFramework):
    ...
    # This test actually causes gemmad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gemmad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gemmad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # gemmad will not send blocktxn responses for blocks whose height is
