...
class BIP66Test(GemmaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gemmad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gemmad produces more specific reject
            # reasons.
