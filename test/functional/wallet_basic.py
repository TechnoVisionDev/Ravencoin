...
class WalletTest(GemmaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GEMS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GEMS with subtract fee from amount
        ...
        # Sendmany 10 GEMS with subtract fee from amount
