...
class AssetTest(GemmaTestFramework):
    ...
    def big_test(self):
        ...
        gemma_assets = n0.listassets(asset="RAVEN*", verbose=False, count=2, start=-2)
        assert_equal(len(gemma_assets), 2)
        assert_equal(gemma_assets[0], "RAVEN2")
        assert_equal(gemma_assets[1], "RAVEN3")
        self.sync_all()
