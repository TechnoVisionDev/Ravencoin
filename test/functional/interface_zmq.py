...
import os
import struct
from test_framework.test_framework import GemmaTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(GemmaTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gemma has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gemmad has not been built with zmq enabled.")
