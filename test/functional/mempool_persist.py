...
By default, gemmad will dump mempool on shutdown and
...
class MempoolPersistTest(GemmaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give gemmad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent gemmad from writing mempool.dat to disk. Verify that `savemempool` fails")
