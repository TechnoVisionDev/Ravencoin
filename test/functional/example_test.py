...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GemmaTestFramework
    pass

class ExampleTest(GemmaTestFramework):
    # Each functional test is a subclass of the GemmaTestFramework class.
    ...
    def custom_method(self):
        ...
        GemmaTestFramework class so other tests can use it."""
