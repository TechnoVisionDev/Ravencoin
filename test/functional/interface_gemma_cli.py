...
class TestGemmaCli(GemmaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `gemma-cli getinfo`")
        ...
        self.log.info("Compare responses from `gemma-cli -getinfo` and the RPCs data is retrieved from.")
