...
class TxnMallTest(GemmaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 GEMS:
        ...
        # First: use raw transaction API to send 1240 GEMS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GEMS coin each
        ...
        # Node0's balance should be starting balance, plus 50GEMS for another
        ...
        # Node0's total balance should be starting balance, plus 100GEMS for 
