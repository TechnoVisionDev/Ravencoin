Contributing to Gemma Core
============================

The Gemma Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to gemma-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the gemma unit tests or QA tests
...
The following applies to code changes to the Gemma project (and related
projects) and is not to be confused with overall Gemma
Network Protocol consensus changes.

Whether a pull request is merged into Gemma rests with the project merge
...
Patches that change Gemma consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gemma consensus, it must have been
...
The GemmaQT-SIG selects a release manager for each Gemma release.
