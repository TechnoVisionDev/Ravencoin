...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(GemmaUnits::GEMS),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(GemmaUnits::formatWithUnit(unit, balance, false, GemmaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(GemmaUnits::formatWithUnit(unit, unconfirmedBalance, false, GemmaUnits::separatorAlways));
    ui->labelImmature->setText(GemmaUnits::formatWithUnit(unit, immatureBalance, false, GemmaUnits::separatorAlways));
    ui->labelTotal->setText(GemmaUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, GemmaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(GemmaUnits::formatWithUnit(unit, watchOnlyBalance, false, GemmaUnits::separatorAlways));
    ui->labelWatchPending->setText(GemmaUnits::formatWithUnit(unit, watchUnconfBalance, false, GemmaUnits::separatorAlways));
    ui->labelWatchImmature->setText(GemmaUnits::formatWithUnit(unit, watchImmatureBalance, false, GemmaUnits::separatorAlways));
    ui->labelWatchTotal->setText(GemmaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, GemmaUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the GEMS balance grid from expanding and looking terrible when asset balance is hidden
