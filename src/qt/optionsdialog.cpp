    ...
    mapper(0)
{
    ...
    ui->gemmaAtStartup->setToolTip(ui->gemmaAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->gemmaAtStartup->setText(ui->gemmaAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGemmaConfButton->setToolTip(ui->openGemmaConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GemmaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gemmaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGemmaConfButton_clicked()
{
