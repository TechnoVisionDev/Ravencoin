...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GemmaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_gemma-qt -platform xcb      # Linux
//     src/qt/test/test_gemma-qt -platform windows  # Windows
//     src/qt/test/test_gemma-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GemmaUnits::formatWithUnit(unit, balance, false, GemmaUnits::separatorAlways);
    ...
    // Amount input
    GemmaAmountField* amountInput = receiveCoinsDialog.findChild<GemmaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: gemma:")) != -1);
