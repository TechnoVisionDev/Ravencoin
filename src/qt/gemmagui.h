...
#ifndef gemma_QT_gemmaGUI_H
#define gemma_QT_gemmaGUI_H
...
/**
  Gemma GUI main class. This class represents the main window of the Gemma UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GemmaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GemmaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~GemmaGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a gemma wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
