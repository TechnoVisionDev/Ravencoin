...
#ifndef gemma_QT_gemmaUNITS_H
#define gemma_QT_gemmaUNITS_H
...
/** Gemma unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GemmaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GemmaUnits(QObject *parent);
...
typedef GemmaUnits::Unit GemmaUnit;

#endif // gemma_QT_gemmaUNITS_H
