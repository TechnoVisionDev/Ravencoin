...
#include "config/gemma-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGemmaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GemmaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGemmaURI(info));
}
