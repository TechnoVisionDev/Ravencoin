...
void WalletView::setGemmaGUI(GemmaGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? GemmaGUI::HD44_ENABLED : _walletModel->hdEnabled() ? GemmaGUI::HD_ENABLED : GemmaGUI::HD_DISABLED);
