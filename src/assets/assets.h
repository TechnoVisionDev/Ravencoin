...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVEN_ASSET GEMSQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET GEMSO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET GEMSR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVEN_ASSET GEMST
