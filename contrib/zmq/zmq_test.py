...
"""
    ...
    Gemma should be started with the command line arguments:
        gemmad -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND GEMS issuance at " + str(pos))
				print("After GEMS: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND GEMS something at " + str(pos))
			start += pos+8
			print(astr)
