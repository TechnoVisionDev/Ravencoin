...
find ${DISTNAME}/bin -type f -executable -exec ../gemmacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../gemmacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/gemmacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/gemmacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
