...
This document provides guidelines for internationalization of the Gemma Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gemma_en.ts` remains unchanged.
