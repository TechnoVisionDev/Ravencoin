...
Below are some notes on how to build Gemma Core for Windows.
...
way. This will install to `c:\workspace\gemma`, for example:

    make install DESTDIR=/mnt/c/workspace/gemma
