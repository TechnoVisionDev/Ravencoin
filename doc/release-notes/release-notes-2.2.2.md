Gemma Core version *2.2.2* is now available!!
==============

  <https://github.com/GemmaProject/Gemma/releases/tag/v2.2.2>
...
- Enhancements for Gemma Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/GemmaProject/Gemma/commits/release_2.2.2>
