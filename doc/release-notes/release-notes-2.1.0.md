Gemma Core version *2.1.0* is now available!!
==============

  <https://github.com/GemmaProject/Gemma/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/GemmaProject/Gemma/commits/release_2.1.0>
